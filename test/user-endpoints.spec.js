    ...
    describe(`Given a valid user`, () => {
      ...
      it(`inserts 1 language with words for the new user`, () => {
        ...
        const expectedList = {
          ...
          total_score: 0,
          words: [
            { character_phrase: '练习', original: 'liànxí', translation: 'practice' },
            { character_phrase: '你好', original: 'nǐ hǎo', translation: 'hello' },
            { character_phrase: '屋', original: 'wū', translation: 'house' },
            { character_phrase: '开发商', original: 'kāifā shāng', translation: 'developer' },
            { character_phrase: '翻译', original: 'fānyì', translation: 'translate' },
            { character_phrase: '惊人', original: 'jīngrén', translation: 'amazing' },
            { character_phrase: '狗', original: 'gǒu', translation: 'dog' },
            { character_phrase: '猫', original: 'māo', translation: 'cat' },
          ]
        }
        return supertest(app)
          .post('/api/user')
          ...
          .then(dbLists => {
            ...
            expectedList.words.forEach((expectedWord, w) => {
              expect(dbWords[w].character_phrase).to.eql(
                expectedWord.character_phrase
              )
